...
const projects = [
  {
    ...
    description: 'A comprehensive digital wallet management platform with multi-role access system and real-time transaction analytics.',
  ...
  },
  {
    ...
    description: 'Complete employee management system with dynamic leave management, real-time notifications, and interactive org charts.',
    techStack: ['MERN', 'Socket.IO', 'React Flow'],
    features: [
  ...
  },
  {
    ...
    description: 'Revolutionary RFP platform with AI-powered proposal generation achieving 60% time reduction in document processing.',
        ...
        <div ref={ref} className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              A selection of projects I've worked on, showcasing my expertise in building scalable, 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <div
                key={project.title}
                className={`group card-glass rounded-2xl overflow-hidden card-hover transition-all duration-700 ${project.glow} ${
